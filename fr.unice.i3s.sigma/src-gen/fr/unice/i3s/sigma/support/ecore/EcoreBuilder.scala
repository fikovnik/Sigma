...
object EcoreBuilder extends EMFBuilder(EcorePackage.eINSTANCE) {
  ...
  object EAttribute {
    def apply(config: (EAttribute ⇒ Any)*): EAttribute =
      contained(build[EAttribute](config: _*))
  }
  
  type EAnnotation = org.eclipse.emf.ecore.EAnnotation
  object EAnnotation {
    def apply(config: (EAnnotation ⇒ Any)*): EAnnotation =
      contained(build[EAnnotation](config: _*))
  }
  
  type EClass = org.eclipse.emf.ecore.EClass
  object EClass {
    def apply(config: (EClass ⇒ Any)*): EClass =
      contained(build[EClass](config: _*))
  }
  
  type EDataType = org.eclipse.emf.ecore.EDataType
  object EDataType {
    def apply(config: (EDataType ⇒ Any)*): EDataType =
      contained(build[EDataType](config: _*))
  }
  
  type EEnum = org.eclipse.emf.ecore.EEnum
  object EEnum {
    def apply(config: (EEnum ⇒ Any)*): EEnum =
      contained(build[EEnum](config: _*))
  }
  
  type EEnumLiteral = org.eclipse.emf.ecore.EEnumLiteral
  object EEnumLiteral {
    def apply(config: (EEnumLiteral ⇒ Any)*): EEnumLiteral =
      contained(build[EEnumLiteral](config: _*))
  }
  
  type EFactory = org.eclipse.emf.ecore.EFactory
  object EFactory {
    def apply(config: (EFactory ⇒ Any)*): EFactory =
      contained(build[EFactory](config: _*))
  }
  
  type EObject = org.eclipse.emf.ecore.EObject
  object EObject {
    def apply(config: (EObject ⇒ Any)*): EObject =
      contained(build[EObject](config: _*))
  }
  
  type EOperation = org.eclipse.emf.ecore.EOperation
  object EOperation {
    def apply(config: (EOperation ⇒ Any)*): EOperation =
      contained(build[EOperation](config: _*))
  }
  
  type EPackage = org.eclipse.emf.ecore.EPackage
  object EPackage {
    def apply(config: (EPackage ⇒ Any)*): EPackage =
      contained(build[EPackage](config: _*))
  }
  
  type EParameter = org.eclipse.emf.ecore.EParameter
  object EParameter {
    def apply(config: (EParameter ⇒ Any)*): EParameter =
      contained(build[EParameter](config: _*))
  }
  
  type EReference = org.eclipse.emf.ecore.EReference
  object EReference {
    def apply(config: (EReference ⇒ Any)*): EReference =
      contained(build[EReference](config: _*))
  }
  
  type EGenericType = org.eclipse.emf.ecore.EGenericType
  object EGenericType {
    def apply(config: (EGenericType ⇒ Any)*): EGenericType =
      contained(build[EGenericType](config: _*))
  }
  
  type ETypeParameter = org.eclipse.emf.ecore.ETypeParameter
  object ETypeParameter {
    def apply(config: (ETypeParameter ⇒ Any)*): ETypeParameter =
      contained(build[ETypeParameter](config: _*))
  }
}
