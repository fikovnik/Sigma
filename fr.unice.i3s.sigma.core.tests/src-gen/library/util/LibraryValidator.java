...
public class LibraryValidator extends EObjectValidator {
	...
	protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
		switch (classifierID) {
			...
			case LibraryPackage.ECHAR_SEQUENCE:
				return validateECharSequence((CharSequence)value, diagnostics, context);
			default:
				return true;
		}
	}
	...
	public boolean validateMember_AtMostTwoLoans(Member member, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(LibraryPackage.Literals.MEMBER,
				 member,
				 diagnostics,
				 context,
				 "http://www.i3s.unice.fr/Sigma",
	 ...
	 * @generated
	 */
	public boolean validateECharSequence(CharSequence eCharSequence, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return true;
	}
