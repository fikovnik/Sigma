 ...
 * <ul>
 *   <li>{@link oo.impl.OperationImpl#getReturnType <em>Return Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OperationImpl extends FeatureImpl implements Operation
{
		...
		if (returnType != null && returnType.eIsProxy())
		{
			...
			if (returnType != oldReturnType)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OOPackage.OPERATION__RETURN_TYPE, oldReturnType, returnType));
			}
		}
		return returnType;
	}
	...
	public void setReturnType(Classifier newReturnType)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OOPackage.OPERATION__RETURN_TYPE, oldReturnType, returnType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case OOPackage.OPERATION__RETURN_TYPE:
