 ...
 * <ul>
 *   <li>{@link relational.impl.ColumnImpl#getName <em>Name</em>}</li>
 *   <li>{@link relational.impl.ColumnImpl#getDataType <em>Data Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ColumnImpl extends EObjectImpl implements Column
{
	...
	public void setDataType(String newDataType)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RelationalPackage.COLUMN__DATA_TYPE, oldDataType, dataType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case RelationalPackage.COLUMN__NAME:
				return getName();
			case RelationalPackage.COLUMN__DATA_TYPE:
				return getDataType();
		}
