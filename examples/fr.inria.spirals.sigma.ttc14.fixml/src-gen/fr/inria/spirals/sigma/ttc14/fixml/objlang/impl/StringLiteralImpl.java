 ...
 * <ul>
 *   <li>{@link fr.inria.spirals.sigma.ttc14.fixml.objlang.impl.StringLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StringLiteralImpl extends ExpressionImpl implements StringLiteral
{
	...
	{
		return ObjLangPackage.Literals.STRING_LITERAL;
	}
	...
	public void setValue(String newValue)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ObjLangPackage.STRING_LITERAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case ObjLangPackage.STRING_LITERAL__VALUE:
				return getValue();
		}
