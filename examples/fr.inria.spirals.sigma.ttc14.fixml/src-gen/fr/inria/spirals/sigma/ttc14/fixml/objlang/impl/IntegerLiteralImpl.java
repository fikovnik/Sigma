 ...
 * <ul>
 *   <li>{@link fr.inria.spirals.sigma.ttc14.fixml.objlang.impl.IntegerLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IntegerLiteralImpl extends ExpressionImpl implements IntegerLiteral
{
	...
	{
		return ObjLangPackage.Literals.INTEGER_LITERAL;
	}
	...
	public void setValue(int newValue)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ObjLangPackage.INTEGER_LITERAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case ObjLangPackage.INTEGER_LITERAL__VALUE:
				return getValue();
		}
