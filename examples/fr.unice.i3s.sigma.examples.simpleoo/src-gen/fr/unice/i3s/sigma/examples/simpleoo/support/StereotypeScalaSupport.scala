...
trait StereotypeScalaSupport extends EMFScalaSupport {
  ...
  protected implicit val _stereotypeProxyBuilder = new EMFProxyBuilder[Stereotype](SimpleOO._simpleooBuilder)
  
  object Stereotype {
    def apply(name: String = null): Stereotype = {
      val _instance = SimpleOO._simpleooBuilder.create[Stereotype]
