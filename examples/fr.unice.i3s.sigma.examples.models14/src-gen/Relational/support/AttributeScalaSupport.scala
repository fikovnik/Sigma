...
trait AttributeScalaSupport extends EMFScalaSupport {
  ...
  protected implicit val _attributeProxyBuilder = new EMFProxyBuilder[Attribute](RelationalPackageScalaSupport._relationalBuilder)
  ...
  object Attribute {
    def apply(name: String = null, type_ : AttributeType = AttributeType.SIMPLE, nullable: Boolean = false, domain: Domain = null, multiplicity: Int = 1): Attribute = {
      val _instance = RelationalPackageScalaSupport._relationalBuilder.create[Attribute]
