...
trait ProtocolStateMachineScalaSupport extends EMFScalaSupport {
  type ProtocolStateMachine = org.eclipse.uml2.uml.ProtocolStateMachine
  
  protected implicit val _protocolstatemachineProxyBuilder = new EMFProxyBuilder[ProtocolStateMachine](UMLPackageScalaSupport._umlBuilder)
  
  object ProtocolStateMachine {
    def apply(): ProtocolStateMachine = {
      UMLPackageScalaSupport._umlBuilder.create[ProtocolStateMachine]
    }
  }
