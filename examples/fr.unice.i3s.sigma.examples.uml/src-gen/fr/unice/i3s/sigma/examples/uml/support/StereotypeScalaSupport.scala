...
trait StereotypeScalaSupport extends EMFScalaSupport {
  ...
  protected implicit val _stereotypeProxyBuilder = new EMFProxyBuilder[Stereotype](UMLPackageScalaSupport._umlBuilder)
  
  object Stereotype {
    def apply(): Stereotype = {
      UMLPackageScalaSupport._umlBuilder.create[Stereotype]
    }
  }
