...
trait MergeNodeScalaSupport extends EMFScalaSupport {
  type MergeNode = org.eclipse.uml2.uml.MergeNode
  
  protected implicit val _mergenodeProxyBuilder = new EMFProxyBuilder[MergeNode](UMLPackageScalaSupport._umlBuilder)
  
  object MergeNode {
    def apply(eAnnotations: EList[EAnnotation] = null, ownedComment: EList[Comment] = null, clientDependency: EList[Dependency] = null, name: String = null, nameExpression: StringExpression = null, visibility: VisibilityKind = VisibilityKind.PUBLIC_LITERAL, isLeaf: Boolean = false, inPartition: EList[ActivityPartition] = null, inInterruptibleRegion: EList[InterruptibleActivityRegion] = null, outgoing: EList[ActivityEdge] = null, incoming: EList[ActivityEdge] = null, redefinedNode: EList[ActivityNode] = null): MergeNode = {
      val _instance = UMLPackageScalaSupport._umlBuilder.create[MergeNode]
...
object MergeNodeScalaSupport extends MergeNodeScalaSupport
