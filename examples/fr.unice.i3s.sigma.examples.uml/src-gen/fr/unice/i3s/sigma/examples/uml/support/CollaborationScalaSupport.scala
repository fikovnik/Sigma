...
trait CollaborationScalaSupport extends EMFScalaSupport {
  type Collaboration = org.eclipse.uml2.uml.Collaboration
  
  protected implicit val _collaborationProxyBuilder = new EMFProxyBuilder[Collaboration](UMLPackageScalaSupport._umlBuilder)
  
  object Collaboration {
    def apply(): Collaboration = {
      UMLPackageScalaSupport._umlBuilder.create[Collaboration]
    }
  }
