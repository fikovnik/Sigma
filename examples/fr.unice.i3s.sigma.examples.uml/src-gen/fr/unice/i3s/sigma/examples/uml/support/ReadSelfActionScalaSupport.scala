...
trait ReadSelfActionScalaSupport extends EMFScalaSupport {
  type ReadSelfAction = org.eclipse.uml2.uml.ReadSelfAction
  
  protected implicit val _readselfactionProxyBuilder = new EMFProxyBuilder[ReadSelfAction](UMLPackageScalaSupport._umlBuilder)
  ...
  object ReadSelfAction {
    def apply(eAnnotations: EList[EAnnotation] = null, ownedComment: EList[Comment] = null, clientDependency: EList[Dependency] = null, name: String = null, nameExpression: StringExpression = null, visibility: VisibilityKind = VisibilityKind.PUBLIC_LITERAL, isLeaf: Boolean = false, inPartition: EList[ActivityPartition] = null, inInterruptibleRegion: EList[InterruptibleActivityRegion] = null, outgoing: EList[ActivityEdge] = null, incoming: EList[ActivityEdge] = null, redefinedNode: EList[ActivityNode] = null, handler: EList[ExceptionHandler] = null, isLocallyReentrant: Boolean = false, localPostcondition: EList[Constraint] = null, localPrecondition: EList[Constraint] = null, result: OutputPin = null): ReadSelfAction = {
      val _instance = UMLPackageScalaSupport._umlBuilder.create[ReadSelfAction]
