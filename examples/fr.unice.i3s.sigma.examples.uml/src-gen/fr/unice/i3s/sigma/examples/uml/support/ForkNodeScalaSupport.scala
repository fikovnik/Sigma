...
trait ForkNodeScalaSupport extends EMFScalaSupport {
  type ForkNode = org.eclipse.uml2.uml.ForkNode
  
  protected implicit val _forknodeProxyBuilder = new EMFProxyBuilder[ForkNode](UMLPackageScalaSupport._umlBuilder)
  
  object ForkNode {
    def apply(eAnnotations: EList[EAnnotation] = null, ownedComment: EList[Comment] = null, clientDependency: EList[Dependency] = null, name: String = null, nameExpression: StringExpression = null, visibility: VisibilityKind = VisibilityKind.PUBLIC_LITERAL, isLeaf: Boolean = false, inPartition: EList[ActivityPartition] = null, inInterruptibleRegion: EList[InterruptibleActivityRegion] = null, outgoing: EList[ActivityEdge] = null, incoming: EList[ActivityEdge] = null, redefinedNode: EList[ActivityNode] = null): ForkNode = {
      val _instance = UMLPackageScalaSupport._umlBuilder.create[ForkNode]
...
object ForkNodeScalaSupport extends ForkNodeScalaSupport
