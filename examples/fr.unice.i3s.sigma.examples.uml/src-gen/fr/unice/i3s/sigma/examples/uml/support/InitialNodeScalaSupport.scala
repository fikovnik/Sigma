...
trait InitialNodeScalaSupport extends EMFScalaSupport {
  type InitialNode = org.eclipse.uml2.uml.InitialNode
  
  protected implicit val _initialnodeProxyBuilder = new EMFProxyBuilder[InitialNode](UMLPackageScalaSupport._umlBuilder)
  
  object InitialNode {
    def apply(eAnnotations: EList[EAnnotation] = null, ownedComment: EList[Comment] = null, clientDependency: EList[Dependency] = null, name: String = null, nameExpression: StringExpression = null, visibility: VisibilityKind = VisibilityKind.PUBLIC_LITERAL, isLeaf: Boolean = false, inPartition: EList[ActivityPartition] = null, inInterruptibleRegion: EList[InterruptibleActivityRegion] = null, outgoing: EList[ActivityEdge] = null, incoming: EList[ActivityEdge] = null, redefinedNode: EList[ActivityNode] = null): InitialNode = {
      val _instance = UMLPackageScalaSupport._umlBuilder.create[InitialNode]
