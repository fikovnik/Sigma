...
trait ActivityFinalNodeScalaSupport extends EMFScalaSupport {
  type ActivityFinalNode = org.eclipse.uml2.uml.ActivityFinalNode
  
  protected implicit val _activityfinalnodeProxyBuilder = new EMFProxyBuilder[ActivityFinalNode](UMLPackageScalaSupport._umlBuilder)
  
  object ActivityFinalNode {
    def apply(eAnnotations: EList[EAnnotation] = null, ownedComment: EList[Comment] = null, clientDependency: EList[Dependency] = null, name: String = null, nameExpression: StringExpression = null, visibility: VisibilityKind = VisibilityKind.PUBLIC_LITERAL, isLeaf: Boolean = false, inPartition: EList[ActivityPartition] = null, inInterruptibleRegion: EList[InterruptibleActivityRegion] = null, outgoing: EList[ActivityEdge] = null, incoming: EList[ActivityEdge] = null, redefinedNode: EList[ActivityNode] = null): ActivityFinalNode = {
      val _instance = UMLPackageScalaSupport._umlBuilder.create[ActivityFinalNode]
...
object ActivityFinalNodeScalaSupport extends ActivityFinalNodeScalaSupport
