...
trait RemoveStructuralFeatureValueActionScalaSupport extends EMFScalaSupport {
  ...
  implicit class RemoveStructuralFeatureValueActionScalaSupport(that: RemoveStructuralFeatureValueAction) {
...
object RemoveStructuralFeatureValueActionScalaSupport extends RemoveStructuralFeatureValueActionScalaSupport
