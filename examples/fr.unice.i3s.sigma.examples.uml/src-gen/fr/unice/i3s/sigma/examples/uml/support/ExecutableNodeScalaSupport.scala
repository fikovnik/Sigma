...
trait ExecutableNodeScalaSupport extends EMFScalaSupport {
  type ExecutableNode = org.eclipse.uml2.uml.ExecutableNode
  
  protected implicit val _executablenodeProxyBuilder = new EMFProxyBuilder[ExecutableNode](UMLPackageScalaSupport._umlBuilder)
  
  object ExecutableNode {
    def apply(eAnnotations: EList[EAnnotation] = null, ownedComment: EList[Comment] = null, clientDependency: EList[Dependency] = null, name: String = null, nameExpression: StringExpression = null, visibility: VisibilityKind = VisibilityKind.PUBLIC_LITERAL, isLeaf: Boolean = false, inPartition: EList[ActivityPartition] = null, inInterruptibleRegion: EList[InterruptibleActivityRegion] = null, outgoing: EList[ActivityEdge] = null, incoming: EList[ActivityEdge] = null, redefinedNode: EList[ActivityNode] = null, handler: EList[ExceptionHandler] = null): ExecutableNode = {
      val _instance = UMLPackageScalaSupport._umlBuilder.create[ExecutableNode]
