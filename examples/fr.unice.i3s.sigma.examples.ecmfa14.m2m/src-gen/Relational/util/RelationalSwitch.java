...
public class RelationalSwitch<T> extends Switch<T>
{
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			...
			case RelationalPackage.ATTRIBUTE:
			{
			...
			case RelationalPackage.CANDIDATE_KEY:
			{
			...
			case RelationalPackage.FOREIGN_KEY:
			{
				...
				if (result == null) result = caseCandidateKey(foreignKey);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RelationalPackage.PRIMITIVE_TYPE:
			{
			...
			case RelationalPackage.ENUMERATION_TYPE:
			{
			...
			case RelationalPackage.ENUMERATED_LITERAL:
			{
			...
			case RelationalPackage.CONSTRAINT:
			{
