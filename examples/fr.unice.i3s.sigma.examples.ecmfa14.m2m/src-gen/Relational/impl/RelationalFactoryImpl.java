...
public class RelationalFactoryImpl extends EFactoryImpl implements RelationalFactory
{
	...
	public EObject create(EClass eClass)
	{
		switch (eClass.getClassifierID())
		{
			...
			case RelationalPackage.ATTRIBUTE: return createAttribute();
			case RelationalPackage.DOMAIN: return createDomain();
			case RelationalPackage.CANDIDATE_KEY: return createCandidateKey();
			case RelationalPackage.FOREIGN_KEY: return createForeignKey();
			case RelationalPackage.PRIMITIVE_TYPE: return createPrimitiveType();
			case RelationalPackage.ENUMERATION_TYPE: return createEnumerationType();
			case RelationalPackage.ENUMERATED_LITERAL: return createEnumeratedLiteral();
			case RelationalPackage.CONSTRAINT: return createConstraint();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue)
	{
		...
		{
			case RelationalPackage.ATTRIBUTE_TYPE:
