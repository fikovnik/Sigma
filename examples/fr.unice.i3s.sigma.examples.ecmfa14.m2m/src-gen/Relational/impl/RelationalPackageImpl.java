...
public class RelationalPackageImpl extends EPackageImpl implements RelationalPackage
{
	 ...
	 * @generated
	 */
	public EReference getTable_CandidateKey()
	{
	...
	public void createPackageContents()
	{
		...
		createEReference(tableEClass, TABLE__CANDIDATE_KEY);
	...
	public void initializePackageContents()
	{
		...
		foreignKeyEClass.getESuperTypes().add(this.getCandidateKey());
		...
		initEReference(getSchema_Domains(), this.getDomain(), null, "domains", null, 0, -1, Schema.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTable_PrimaryKey(), this.getCandidateKey(), null, "primaryKey", null, 1, 1, Table.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTable_CandidateKey(), this.getCandidateKey(), null, "candidateKey", null, 1, -1, Table.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTable_Attributes(), this.getAttribute(), null, "attributes", null, 1, -1, Table.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getAttribute_Domain(), this.getDomain(), null, "domain", null, 1, 1, Attribute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAttribute_Multiplicity(), ecorePackage.getEInt(), "multiplicity", "1", 1, 1, Attribute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(attributeTypeEEnum, AttributeType.SIMPLE);
		addEEnumLiteral(attributeTypeEEnum, AttributeType.DERIVATE);
