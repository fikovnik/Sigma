...
public class JSigmaSettingDelegate extends
	...
	public JSigmaSettingDelegate(EStructuralFeature target,
			JSigmaDelegateDomain domain) {
		super(target, domain);
		...
		settingDelegate = new BasicSettingDelegate.Stateless(target) {
			...
			protected Object get(InternalEObject owner, boolean resolve,
					boolean coreType) {
				return JSigmaSettingDelegate.this.get(owner, resolve, coreType);
			}
