...
public class JSigmaInvocationDelegate extends AbstractSigmaDelegate<EOperation>
		implements EOperation.Internal.InvocationDelegate {

	public JSigmaInvocationDelegate(EOperation target, JSigmaDelegateDomain domain) {
		super(target, domain);
	}
